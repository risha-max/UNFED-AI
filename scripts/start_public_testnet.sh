...
DAEMON_STAKE_EVM_PRIVATE_KEY="${DAEMON_STAKE_EVM_PRIVATE_KEY:-}"
...
NODE_STAKE_EVM_PRIVATE_KEY="${NODE_STAKE_EVM_PRIVATE_KEY:-}"
...
if [[ -n "$DAEMON_STAKE_EVM_PRIVATE_KEY" ]]; then
  DAEMON_CMD="UNFED_STAKE_EVM_PRIVATE_KEY=${DAEMON_STAKE_EVM_PRIVATE_KEY} ${DAEMON_CMD}"
fi

if [[ -n "$NODE_STAKE_EVM_PRIVATE_KEY" ]]; then
  NODE_CMD="UNFED_STAKE_EVM_PRIVATE_KEY=${NODE_STAKE_EVM_PRIVATE_KEY} ${NODE_CMD}"
fi
